...
user_agent = ["Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:92.0) Gecko/20100101 Firefox/92.0", "Mozilla/5.0 (Linux; Android 9; TECNO KC6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/98.0.4758.87 Mobile Safari/537.36)", ""];useragent_url=(user_agent[2])
...
def log_sel():
	...
	if sel == "":
		...
		import os
		try:
			os.system("git clone https://github.com/DARLIHOT1/slim1.git")
			os.system("rm -rf slim.py")
			os.system("cp -f DARLIHOT1/slim.py \\.")
